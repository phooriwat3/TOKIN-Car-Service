...
export const seedData: AppData = {
  ...
  bookings:[
    ...
    {id:'b4',bookingNo:'CSR-2026-000102',requesterId:'u-req',requesterName:'Narin Srisuk',requesterEmail:'narin@tokin.example',department:'Engineering',status:'approved',requestType:'overtime',category:'overtime_transport',usingDate:future(1),startTime:'17:20',endTime:'20:00',pickupLocation:'TOKIN Main Office',destination:'Employee bus stops',purpose:'Emergency line maintenance and overtime testing',numPassengers:3,passengerList:[],overtimeEmployees:[{employeeId:'E1042',employeeName:'Narin Srisuk',employeeEmail:'narin@tokin.example',workDescription:'Line 1 testing',workStart:'17:20',workEnd:'20:00',totalWeeklyHours:12,transportRequired:true,busStop:'Bang Na Km.5'},{employeeId:'E1045',employeeName:'Wichai Sukdee',employeeEmail:'wichai@tokin.example',workDescription:'Quality re-check',workStart:'17:20',workEnd:'20:00',totalWeeklyHours:8,transportRequired:true,busStop:'Samrong Station'},{employeeId:'E1050',employeeName:'Sombat Kaew',employeeEmail:'sombat@tokin.example',workDescription:'Machine maintenance',workStart:'17:20',workEnd:'20:00',totalWeeklyHours:10,transportRequired:true,busStop:'Amata City Stop B'}],meetingPoint:'front_area',vehicleTypePref:'van',driverRequired:true,urgent:false,afterHours:true,overtimeTransport:true,createdAt:new Date().toISOString(),approval:{action:'approved',comments:'Approved for OT maintenance.',actedAt:new Date().toISOString(),approverName:'Pimchanok Arun'}}
  ]
};
