    ...
    <div className="mx-auto max-w-6xl p-4 py-8 md:p-8">
      ...
      {request && state !== 'loading' && state !== 'error' && <form onSubmit={save} className="space-y-5">
        ...
        <Card className="p-5"><h2 className="mb-4 font-bold">Request details</h2><div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <Field label="Request type"><Select disabled={disabled} value={request.requestType} onChange={e => switchRequestType(e.target.value as RequestType)}><option value="outside_company">CAR SERVICE REQUISITION</option><option value="overtime">OVERTIME / HOLIDAY WORK</option></Select></Field>
