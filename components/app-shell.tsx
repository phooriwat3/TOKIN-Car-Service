...
export function AppShell({ children }: { children: React.ReactNode }) {
    const { role, user, setRole } = useApp();
    ...
    </select><Button variant="ghost" title="Demo logout" onClick={() => router.push('/login')}><LogOut size={17} /></Button></div></header><main className="mx-auto max-w-[1440px] p-4 md:p-7">{children}</main></div></div>
}
